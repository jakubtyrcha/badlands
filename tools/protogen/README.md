...
| `protogen_tests.cpp` | the `--test` sanity suite (83 assertions) |
...
`protogen --test` — **83 assertions** on 32–1024 cell grids at (mostly) the
...
| section | assertions |
|---|---|
| mass conservation, determinism, knob liveness, discharge/valley/repose/lobe/bedrock/substrate/symmetry/resolution (phase 0 core) | 20 |
